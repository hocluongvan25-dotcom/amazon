...
| **G3** | 5 | `concentration.ts` (CR3/HHI/1P/sponsored), bảng + biểu đồ thị phần SVG, Tab 2 trên web (chưa PDF) | Phân hệ 2 chạy thật; quyết định mua gói $66 dựa trên kết quả trial | Quyết định ngân sách $66/tháng |
